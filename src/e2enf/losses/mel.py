...
def stft(x, fft_size, hop_size, win_length, window, center=True, onesided=True, power=False):
...
class MelSpectralLoss(nn.Module):
    ...
    def __init__(
        ...
        melmat = librosa_mel(sr=sample_rate, n_fft=fft_size, n_mels=n_mels, fmin=fmin, fmax=fmax).T
